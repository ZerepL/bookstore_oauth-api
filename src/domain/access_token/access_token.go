...
import (
	"fmt"
	crypto_utils "github.com/ZerepL/bookstore_oauth-api/src/utils"
...
func (at *AccessTokenRequest) Validate() internalErrors.RestErr {
	switch at.GrantType {
	...
	default:
		return internalErrors.NewBadRequestError("invalid grant_type parameter")
	}
